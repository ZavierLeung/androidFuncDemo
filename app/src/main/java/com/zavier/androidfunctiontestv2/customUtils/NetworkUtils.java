...
public final class NetworkUtils {
     ...
     */
    public void registerNetworkStatusChangedListener(OnNetworkStatusChangedListener listener) {
     ...
     * @param listener The status of network changed listener
     */
    public void unregisterNetworkStatusChangedListener(OnNetworkStatusChangedListener listener) {
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        mContext.getApplicationContext().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
            thread.start();
            ...
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        mContext.getApplicationContext().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
            thread.start();

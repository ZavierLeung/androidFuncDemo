...
public class BtReceiver extends BroadcastReceiver {
    ...
    public BtReceiver(Context cxt, Listener listener, Handler handler) {
        mListener = listener;
        mHandler = handler;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case BluetoothAdapter.ACTION_DISCOVERY_STARTED:
                MessageUtils.sendMessage(mHandler, MessageUtils.MSG_BLUETOOTH_DISCOVERY_STARTED,
                        ((ComponentActivity)context).getResources().getString(R.string.bluetooth_file_test_scan_start));
                break;
            case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                MessageUtils.sendMessage(mHandler, MessageUtils.MSG_BLUETOOTH_DISCOVERY_FINISHED,
                        ((ComponentActivity)context).getResources().getString(R.string.bluetooth_file_test_scan_finish));
                break;
    ...
    public interface Listener {
        void foundBtDev(BluetoothDevice dev);
    }
}
